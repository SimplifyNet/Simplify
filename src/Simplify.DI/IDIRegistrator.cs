...
public interface IDIRegistrator
{
	...
	IDIRegistrator Register(Type serviceType, Type implementationType, LifetimeType lifetimeType = LifetimeType.PerLifetimeScope);
	...
	IDIRegistrator Register(Type serviceType, Func<IDIResolver, object> instanceCreator,
